...
"""
        # for further updates: Web crawler function
            import mechanize  # Virtual browsing library
            from bs4 import BeautifulSoup  # html parser
"""

"""
    This class will be run on a new thread.
"""
...
class PSDDealer:
    ...
    def askrun(self, iterate=0):
        ...
        # terminate thread
        if self.stop and self.apphandler.bool_repeat.get() == 0:
            # Repeats task
            print "[!!] thread complete"
            # Let app know this thread is terminated
...
class TextureDealer:
    ...
    After atlas created, send atlas to Project directory.
    Requires proper configuration at "conf.json" file. """
