...
struct ReadOnlyCollection_1_t8063  : public Object_t
{
	// System.Collections.Generic.IList`1<T> System.Collections.ObjectModel.ReadOnlyCollection`1<System.Collections.Generic.List`1<System.Boolean>>::list
	Object_t* ___list;
};
