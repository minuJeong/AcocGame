...
struct FlexibleListWrapper_2_t1783  : public Object_t
{
	// System.Collections.Generic.IList`1<TIn> Parse.Internal.FlexibleListWrapper`2<System.Object,Parse.ParseRole>::toWrap
	Object_t* ___toWrap;
};
