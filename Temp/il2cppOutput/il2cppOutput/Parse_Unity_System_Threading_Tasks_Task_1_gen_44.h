...
struct Task_1_t6897  : public Task_t390
{
	// T System.Threading.Tasks.Task`1<System.Threading.Tasks.Task`1<System.Collections.Generic.IEnumerable`1<Parse.ParseRole>>>::result
	Task_1_t6884 * ___result;
};
