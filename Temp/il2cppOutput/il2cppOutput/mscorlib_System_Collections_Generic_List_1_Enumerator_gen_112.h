...
struct Enumerator_t8850 
{
	...
	int32_t ___ver;
	// T System.Collections.Generic.List`1/Enumerator<System.Collections.Generic.Dictionary`2<System.String,Parse.ParseGeoPoint>>::current
	Dictionary_2_t2226 * ___current;
};
