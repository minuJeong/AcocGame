...
void g_LitJson_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	...
	}
	{
		...
		AssemblyTitleAttribute__ctor_m4600(tmp, il2cpp_codegen_string_new_wrapper("LitJson"), &AssemblyTitleAttribute__ctor_m4600_MethodInfo);
	...
	}
	{
		...
		AssemblyDescriptionAttribute__ctor_m4601(tmp, il2cpp_codegen_string_new_wrapper("LitJSON library"), &AssemblyDescriptionAttribute__ctor_m4601_MethodInfo);
	...
	}
	{
		...
		AssemblyProductAttribute__ctor_m4604(tmp, il2cpp_codegen_string_new_wrapper("LitJSON"), &AssemblyProductAttribute__ctor_m4604_MethodInfo);
	...
	}
	{
		...
		AssemblyCopyrightAttribute__ctor_m4605(tmp, il2cpp_codegen_string_new_wrapper("The authors disclaim copyright to this source code"), &AssemblyCopyrightAttribute__ctor_m4605_MethodInfo);
