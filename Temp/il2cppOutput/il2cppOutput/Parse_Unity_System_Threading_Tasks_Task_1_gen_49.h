...
struct Task_1_t7021  : public Task_t390
{
	// T System.Threading.Tasks.Task`1<System.Threading.Tasks.Task`1<System.Threading.Tasks.Task`1<Parse.ParseUser>>>::result
	Task_1_t1597 * ___result;
};
